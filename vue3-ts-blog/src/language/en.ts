export default {
    ...
    inputMessage: {
        ...
        packageNameLimit: 'Collection name must be 1-64 characters and not start with a space',
        commentTooLong: 'Comment cannot exceed 10000 characters',
        contentTooLong: 'Body cannot exceed 100000 characters',
        useMarkdown: 'Please use markdown syntax',
        abstractHint: 'Optional — auto-generated from the body if left blank; a <!-- more --> marker in the body also sets the cut point',
